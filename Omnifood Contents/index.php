    ...
    <body>
        <header>
            ...
            <div class="hero-text-box">
                ...
                <a class="btn btn-ghost js--scroll-start" href="#">Show me more</a>
            </div>
            
            
        </header>
       
        <section class="section-features js--section-feature" id="features">
            <div class="row">
            ...
            <div class="row js--wp-1">
                ...
                <div class="col span-1-of-4 box">
                    <i class="far fa-smile icon-big"></i>
                ...
                <div class="col span-1-of-4 box">
                    <i class="fab fa-apple icon-big"></i>
                    <h3>100% organic</h3>
            ...
            <div class="row">
                <div class="col span-1-of-3">
                    <div class="plan-box js--wp-4">
                        ...
                        <div>
                            <ul>
                                <li><i class="fas fa-check icon-sm"></i> 1 meal every day</li>
                                <li><i class="fas fa-check icon-sm"></i> Order 24/7</li>
                                <li><i class="fas fa-check icon-sm"></i> Access to newest creations</li>
                                <li><i class="fas fa-check icon-sm"></i> Free delivery</li>
                            </ul>
                        </div>
                ...
                <div class="col span-1-of-3">
                    <div class="plan-box">
                        ...
                        <div>
                            <ul>
                                <li><i class="fas fa-check icon-sm"></i> 1 meal 10 days/month</li>
                                <li><i class="fas fa-check icon-sm"></i> Order 24/7</li>
                                <li><i class="fas fa-check icon-sm"></i> Access to newest creations</li>
                                <li><i class="fas fa-check icon-sm"></i> Free delivery</li>
                            </ul>
                ...
                <div class="col span-1-of-3">
                    <div class="plan-box">
                        ...
                        <div>
                            <ul>
                                <li><i class="fas fa-check icon-sm"></i> 1 meal</li>
                                <li><i class="fas fa-check icon-sm"></i> Order from 8 am to 12 pm</li>
                                <li><i class="fas fa-times icon-sm"></i> </li>
                                <li><i class="fas fa-check icon-sm"></i> Free delivery</li>
                            </ul>
                        </div>
        ...
        <footer>
            ...
            <script src="//cdn.jsdelivr.net/selectivizr/1.0.3b/selectivzr.min.js"></script>
			<script src="vendors/javascript/jquery.waypoints.min.js"></script>
			<script src="http://maps.google.com/maps/api/js"></script>
            <script src="resources/javascript/script.js"></script>
            <script src="resources/javascript/gmaps.js"></script>
